...
namespace NzbDrone.Core.Test.MetadataSource.SkyHook
{
    ...
    public class SkyHookProxyFixture : CoreTest<SkyHookProxy>
    {
        ...
        public void should_be_able_to_get_artist_detail(string mbId, string name)
        {
            ...
            ValidateAlbums(details.ReleaseGroups.Value);
        ...
        [TestCase("12fa3845-7c62-36e5-a8da-8be137155a72", 1, 13, "Hysteria")]
        [TestCase("12fa3845-7c62-36e5-a8da-8be137155a72", 2, 27,"Hysteria")]
        public void should_be_able_to_get_album_detail_with_release(string mbId, int mediaCount, int trackCount, string name)
        {
            var details = Subject.GetAlbumInfo(mbId);
            ...
            // TODO fix
            // details.Item2.Media.Count.Should().Be(mediaCount);
        ...
        {
            Assert.Throws<ReleaseGroupNotFoundException>(() => Subject.GetAlbumInfo("66c66aaa-6e2f-4930-8610-912e24c63ed1"));
        }
